...
def parse_args():
    ...
    parser.add_argument('--random_label', type=bool, default=False,   #fjf  改为False
...
if __name__ == '__main__':
    ...
    # model=torch.load('E:/USTC/CODE_ZERO/Causal-Screening-master-fjf/trained/gnns/mutag_net.pt')
    # # _, train_acc = Gtest(test_loader,
    # #                      model,
    # #                      criterion=nn.CrossEntropyLoss()
    # #                      )
    # for i in model.state_dict():
    #     print(i,model.state_dict()[i].shape)
    ...
    torch.save(model,  osp.join('E:/USTC/CODE_ZERO/Causal-Screening-master-fjf'+ save_path))
