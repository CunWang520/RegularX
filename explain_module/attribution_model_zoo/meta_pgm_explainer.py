...
class MetaPGMExplainer:
    ...
    def batch_perturb_features_on_node(self, num_samples, index_to_perturb,
        ...
        self.model(self.graph.x, self.graph.edge_index, self.graph.edge_attr, self.graph.batch)
        ...
        for iteration in range(num_samples):
            ...
            self.model(X_perturb, self.graph.edge_index, self.graph.edge_attr, self.graph.batch)
