...
refine = torch.load(f'param/refine/{args.dataset}-{args.reg_enlarge}.pt')
...
with open(os.path.join(args.result_dir, f"{args.dataset}-{args.reg_enlarge}_results.json"), "w") as f:
