...
from explain_module.attribution_model_zoo.meta_gnnexplainer import MetaGNNGExplainer
...
class GNNExplainer(Explainer):
    ...
    def explain_graph(self,r, graph,
                      model=None,
                      epochs=200,
                      lr=1e-2,
                      draw_graph=0,
        ...
        explainer = MetaGNNGExplainer(r,model, epochs=epochs, lr=lr)
